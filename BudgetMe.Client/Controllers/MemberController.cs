...
//         {
//             Member loggedInMember = GetMember(1);
//             {
//                 loggedInMember.Budget = GetBudget(1);
...
//         {
//         string path = $"https://localhost:5001/Member/{id}";
//         Member member = null;
...
//         {
//         string path = $"https://localhost:5001/Budget/{id}";
//         Budget budget = null;
//         HttpResponseMessage response = await client.GetAsync(path);
//         if (response.IsSuccessStatusCode)
//         {
